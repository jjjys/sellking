...
## 라이선스
이 프로젝트는 개인 사용을 위한 것이며, 있는 그대로 제공됩니다. 네이버의 이용 약관 및 관련 법률을 준수하세요.

## 참고 자료
- [Selenium 문서](https://www.selenium.dev/documentation/)
- [undetected-chromedriver](https://github.com/ultrafunkamsterdam/undetected-chromedriver)
- [Gmail SMTP 설정](https://kincoding.com/entry/Google-Gmail-SMTP-%EC%82%AC%EC%9A%A8%EC%9D%84-%EC%9C%84%ED%95%9C-%EC%84%B8%ED%8C%85-2025%EB%85%84-%EB%B2%84%EC%A0%84)